const DB = {
    ...
    "Bot.": ["Why does everyone think I'm a bot?", "I'm not a bot.", "Are you a bot?", "We're all bots, then."],
    ...
    "Have saex with me.": ["Are you hot?", "Are you cute?", "Nah, I good.", "Why???", "Why would I do that?"],
    ...
    "Is it cold in Hell?": ["Guess 🥶", "Oh, yeah 🥶\nAll the water's frozen.", "Very cold 🥶"],
    ...
    "What is your species name?": ["Klingon.", "Plutonian.", "Just call it Plutonian. Easier that way 😒"],
    ...
    "What kind of land is in Hell?": ["It's all rock and rock hard ice 😅", "Solid rock, and rock solid ice 😅", "Frozen rocks 🤔"],
    ...
    "Who you are.": ["My name is Isabella! Nice to meet you?", "I'm Isabella! I'm the coolest chatb - person you will ever see! :)", "I'm Isabella!"],
    "Who's he?": ["Who?"],
